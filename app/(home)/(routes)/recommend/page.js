...
export default function App() {
    ...
    const handleSubmit = async () => {
        const prompt = {
          role: "user",
          content: input + ' Give roadmap for this topic to study with resources',
        };
  ...
  return (
    <div className="App">
      <div className="Column">
        <h3 className="text-blue-500 text-2xl mb-4">Enter the topic for roadmap and resources</h3>
